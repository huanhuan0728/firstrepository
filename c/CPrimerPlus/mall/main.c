...
//  mall
//
//  Created by xuhuan lu on 2023/1/10.
//

#include <stdio.h>
#include <stdlib.h>                             //提供rand()和srand()函数的原型
#include <time.h>                               //提供time()的原型
#include "queue.h"
#define MIN_PER_HR 60.0

bool newcustomer(double x);                     //是否有新的顾客到来
...
int main(int argc, const char * argv[]) {
    ...
    scanf("%d", &hours);
    cyclelimit = MIN_PER_HR / perhours;
    ...
    if(customers > 0){
        ...
        printf(" average wait time: %.2f miuntes\n",
